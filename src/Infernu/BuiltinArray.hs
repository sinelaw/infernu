...
arrayProps elemType = let aType = array elemType in
  ...
  , ("map", TScheme [0] (func aType (funcN [undef, elemType, number, aType, tvar 0]) (array $ tvar 0)) TPredNothing)-- requires type variables, and maybe foralls on row properties
